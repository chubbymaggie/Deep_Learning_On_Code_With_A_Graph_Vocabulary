...
if __name__ == '__main__':
    kwargs = dict(seed=515,
                  ...
                  model_names_labels_and_prepro_kwargs=[
                      ('FITBFixedVocabDTNN', 'all_edge', frozenset(),
                       dict(),
                       dict(max_nodes_per_graph=500)),
                      ('FITBNameGraphVocabDTNN', 'all_edge', frozenset(),
                       dict(max_name_encoding_length=30),
                       dict(max_nodes_per_graph=500)),
                      ('FITBFixedVocabRGCN', 'all_edge', frozenset(),
                       dict(),
                       dict(max_nodes_per_graph=500)),
                      ('FITBNameGraphVocabRGCN', 'all_edge', frozenset(),
                       dict(max_name_encoding_length=30),
                       dict(max_nodes_per_graph=500)),
                      ('FITBFixedVocabGAT', 'all_edge', frozenset(),
                       dict(),
                       dict(max_nodes_per_graph=500)),
                      ('FITBNameGraphVocabGAT', 'all_edge', frozenset(),
                       dict(max_name_encoding_length=30),
                       dict(max_nodes_per_graph=500)),
                  ],
